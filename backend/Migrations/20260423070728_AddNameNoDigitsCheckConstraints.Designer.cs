...
namespace api.Migrations
{
    ...
    [Migration("20260423070728_AddNameNoDigitsCheckConstraints")]
    partial class AddNameNoDigitsCheckConstraints
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("backend.src.Domain.Models.Patient", b =>
                {
                    ...
                    b.ToTable("Patients", t =>
                        {
                            t.HasCheckConstraint("CK_Patients_Name_NoDigits", "\"Name\" !~ '\\d'");
                        });
                });
            ...
            modelBuilder.Entity("backend.src.Domain.Models.Personnel", b =>
                {
                    ...
                    b.ToTable("Personnel", t =>
                        {
                            t.HasCheckConstraint("CK_Personnel_Name_NoDigits", "\"Name\" !~ '\\d'");
                        });
                });
