...
export default function CategoryTree({
  ...
  const [creatingScoreRuleFor, setCreatingScoreRuleFor] = useState<
    number | null
  >(null);
                  ...
                  <div className="bg-white border-t divide-y">
                    {categoryQuestions.length === 0 ? (
                      ...
                      categoryQuestions.map((question) => {
                        const questionIsExpanded = expandedQuestions.has(
                          question.questionId,
                        );
                        const hasOptions =
              ...
              return (
                ...
                >
                  <div className="flex justify-between items-start mb-3">
                    ...
                    <button
                      onClick={() =>
                        setCreatingScoreRuleFor(category.categoryId)
                      }
                  ...
                  {scoreRules.length > 0 ? (
                          ...
                          <div className="flex justify-between items-start gap-2">
                            <div className="flex-1 min-w-0">
                              ...
                              <div className="text-xs text-purple-700 mt-1">
                                Score {(rule as any).operator}{" "}
                                {(rule as any).scoreThreshold} • Priority:{" "}
                                {rule.priority}
                              </div>
                            </div>
                            <div className="flex gap-1 flex-shrink-0">
                    ...
                    <p className="text-xs text-gray-500 pt-2">
                      No score rules for this category yet
                    </p>
                  )}
                </div>
              );
      ...
      {creatingScoreRuleFor && (
        <ScoreRuleEditor
          ...
          category={categories.find(
            (c) => c.categoryId === creatingScoreRuleFor,
          )}
